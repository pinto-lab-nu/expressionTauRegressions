...
def plot_regressions(generate_plots, generate_summary, lineSelection, structList, areaColors, plottingConditions, params, paths, titles, model_vals, plotting_data, regressions_to_plot='All', paper_plotting=False, cross_layers='All', super_verbose=False):
